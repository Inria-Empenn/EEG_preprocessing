...
topomax = zeros(nb,30); %Create empty variable to count number of peaks for each electrode for difference wave
win_topomax = zeros(nb,12); %Create empty variable to count number of peaks for each electrode for condition 1
lose_topomax = zeros(nb,12); %Create empty variable to count number of peaks for each electrode for condition 2
...
label = round((sum(topomax)/nb)*100); %Determine percetange that each electrode had a max peak for difference wave
win_label = round((sum(win_topomax)/nb)*100); %Determine percetange that each electrode had a max peak for condition 1
lose_label = round((sum(lose_topomax)/nb)*100); %Determine percetange that each electrode had a max peak for condition 2
...
topomax_FFT_delta = zeros(nb,30); %Create empty variable to count number of peaks for each electrode for difference wave
topomax_FFT_theta = zeros(nb,30); %Create empty variable to count number of peaks for each electrode for difference wave
gain_topomax_FFT_delta = zeros(nb,30); %Create empty variable to count number of peaks for each electrode for condition 1
loss_topomax_FFT_theta = zeros(nb,30);  %Create empty variable to count number of peaks for each electrode for condition 2
...
label_FFT_delta = round((sum(topomax_FFT_delta)/nb)*100); %Determine percetange that each electrode had a max delta peak for difference wave
label_FFT_theta = round((sum(topomax_FFT_theta)/nb)*100); %Determine percetange that each electrode had a max theta peak for difference wave
gain_label_FFT_delta = round((sum(gain_topomax_FFT_delta)/nb)*100); %Determine percetange that each electrode had a max delta peak for condition 1
loss_label_FFT_theta = round((sum(loss_topomax_FFT_theta)/nb)*100); %Determine percetange that each electrode had a max theta peak for condition 2
