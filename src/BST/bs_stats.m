...
% % Section 1: Compute the statistical map(channels x time) showing the difference between Brainstorm and paper results in terms of conditional erp
...
diff_btw(1,3)=length(find(StatDiff));
