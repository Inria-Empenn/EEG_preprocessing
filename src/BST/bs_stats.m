...
All_ERP1=All_ERP;
load('../../results/bs_All_ERP_samePipe.mat')
All_ERP2=All_ERP_BS;

All_ERP1=All_ERP1(:,151:750,:,:);
All_ERP2=All_ERP2(:,:,:,:).*1000000;
...
for cond=1:3 
    for ch=1:29
        ...
        if(cond==3)
            ...
            x2=squeeze(All_ERP2(1,ch,:,:))-squeeze(All_ERP2(2,ch,:,:));
        else
          x1=squeeze(All_ERP1(ch,:,cond,:));
          x2=squeeze(All_ERP2(cond,ch,:,:));
        end
