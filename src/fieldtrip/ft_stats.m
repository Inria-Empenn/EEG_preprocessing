...
All_ERP1=All_ERP;
load('../../results/ft_All_ERP_samePipe.mat')
All_ERP2=All_ERP;
...
for cond=1:3 
    for ch=1:29
        ...
        if(cond==3)
            ...
            x2=squeeze(All_ERP2(2,ch,:,:))-squeeze(All_ERP2(1,ch,:,:));
        else
                  if(cond==1)
                      x1=squeeze(All_ERP1(ch,:,1,:));
                      x2=squeeze(All_ERP2(2,ch,:,:));
                  else
                      if(cond==2)
                          x1=squeeze(All_ERP1(ch,:,2,:));
                          x2=squeeze(All_ERP2(1,ch,:,:));
                      end
                  end
        end
